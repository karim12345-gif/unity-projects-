...
public class Traveler : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        // debugging
        GameObject startGameObject = GameObject.FindGameObjectWithTag("Start");
        Waypoint startWaypoint = startGameObject.GetComponent<Waypoint>();
    ...
    /// <summary>
    /// Goes to the next waypoint in the path
    /// </summary>
    ...
    /// <summary>
    /// Blows up waypoints on the path except for the start and end node
    /// </summary>
